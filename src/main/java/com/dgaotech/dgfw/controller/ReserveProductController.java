...
public class ReserveProductController {
	...
	private ReserveProductService reserveProductService;
	  ...
	  @ResponseBody
	  @RequestMapping(value = "/mobile.service/getReserveList", method = RequestMethod.POST,produces = MediaType.APPLICATION_JSON_VALUE)
	  public Map<String, Object> rechargeinfo(@RequestBody JSONObject jsoncode, HttpServletResponse response) throws Exception{
		  ...
		  return  reserveProductService.getByPreSale();	  
	  }
}
