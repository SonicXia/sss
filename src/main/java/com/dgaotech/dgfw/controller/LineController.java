...
public class LineController {
	...
	/***
	 * Restful 方式得到两个接口： 1. 完全调出线路信息 2.根据线路id号得出线路信息
	 * 
	 * @param id
	 * @return
	 * @throws Exception
	...
	public List lineinfo(@PathVariable("id") String id, @RequestBody JSONObject jsoncode, HttpServletResponse response)
			throws Exception {
	...
	public @ResponseBody String getAll(@PathVariable("namespace") String namespace, @PathVariable("set") String set,
	...
	// @ResponseBody
	// @RequestMapping(value = "/mykey", method = RequestMethod.POST,produces =
